...
#include "DragonCrashMultiplayerGameMode.h"


DEFINE_LOG_CATEGORY(DragonCrashDedicatedServer);

ADragonCrashMultiplayerGameMode::ADragonCrashMultiplayerGameMode(const FObjectInitializer& ObjectInitializer)
...
void ADragonCrashMultiplayerGameMode::OnStartGameSession(Aws::GameLift::Server::Model::GameSession GameLiftSession)
{
#if WITH_GAMELIFT
...
void ADragonCrashMultiplayerGameMode::OnTerminate()
{
#if WITH_GAMELIFT
...
bool ADragonCrashMultiplayerGameMode::OnHealthCheck()
{
#if WITH_GAMELIFT
...
void ADragonCrashMultiplayerGameMode::PreLogin(const FString& Options, const FString& Address, const FUniqueNetIdRepl& UniqueId, FString& ErrorMessage)
{
#if WITH_GAMELIFT
...
FString ADragonCrashMultiplayerGameMode::InitNewPlayer(APlayerController* NewPlayerController, const FUniqueNetIdRepl& UniqueId, const FString& Options, const FString& Portal)
{
#if WITH_GAMELIFT
	FString PlayerSessionId = ParseOption(Options, TEXT("id"));
...
void ADragonCrashMultiplayerGameMode::Logout(AController* Exiting)
{
#if WITH_GAMELIFT
